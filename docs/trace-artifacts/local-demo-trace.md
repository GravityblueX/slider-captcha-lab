...
Generated: 2026-06-24T03:40:23.376909+00:00
Scope: `local_owned_or_explicitly_authorized_pages_only`
Status: `OK`
Profile: `examples\authorized_deep_page_profile.json`
Screenshot: `docs\trace-artifacts\local-demo.png`

## Selector Visibility

| Selector | Visible | Box |
|---|---|---|
| `#knob` | `True` | x=284, y=378.94, width=48, height=48 |
| `#slider` | `True` | x=280, y=374.94, width=720, height=56 |
